...
--
-- Host: 127.0.0.1    Database: aspnet-shoppinglistarduino
-- ------------------------------------------------------
...
INSERT INTO `__efmigrationshistory` VALUES ('00000000000000_CreateIdentitySchema','2.1.8-servicing-32085'),('20190602212250_AddProducts','2.1.8-servicing-32085'),('20190614155936_ProductsIdAutoIncrement','2.1.8-servicing-32085');
...
CREATE TABLE `userproduct` (
  ...
  CONSTRAINT `FK_userproduct_AspNetUsers_UserId` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_userproduct_products_ProductId` FOREIGN KEY (`ProductId`) REFERENCES `products` (`Id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userproduct` VALUES (1,'6fdf3b68-bb2d-4f4b-bddd-765553db3e06',16),(2,'6fdf3b68-bb2d-4f4b-bddd-765553db3e06',2),(11,'6fdf3b68-bb2d-4f4b-bddd-765553db3e06',3),(13,'6fdf3b68-bb2d-4f4b-bddd-765553db3e06',1),(14,'6fdf3b68-bb2d-4f4b-bddd-765553db3e06',1),(17,'6fdf3b68-bb2d-4f4b-bddd-765553db3e06',2),(18,'6fdf3b68-bb2d-4f4b-bddd-765553db3e06',1);
...
-- Dump completed on 2019-06-20  0:50:54
